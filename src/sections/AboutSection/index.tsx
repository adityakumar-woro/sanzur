  ...
  return (
    ...
    >
      <div ref={sectionRef} className="relative z-10 w-full">
        ...
        >
          <p className="font-newsreader italic text-xl md:text-2xl text-black/70">
            About Us
          </p>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-10 md:gap-16">
          ...
          {/* Right Content */}
          <motion.div
            className="w-full md:w-[45%] flex flex-col justify-center gap-7 md:gap-8"
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              <p className="font-dm_sans font-light text-sm md:text-base leading-relaxed text-black/70">
                We are a passionate interior design practice dedicated to
                crafting timeless, client-centric spaces that blend
                functionality with refined aesthetics. With over a decade of
                experience across residential and commercial projects,
              </p>

              <p className="font-dm_sans font-light text-sm md:text-base leading-relaxed text-black/70">
                we transform ideas into immersive environments where thoughtful
                planning, innovation, and detail come together to elevate
                everyday living.
              </p>
            </div>
